...
def main(cfg_path: str):
    ...
    # Datasets (windowed training, full-trip eval handled elsewhere)
    ...
    print(f"[train] model={model_name}, window={cfg.get('window')}, horizon={horizon}, feat_dim={feat_dim}, device={device}")
