...
class AISDatasetBase(Dataset):
    """
    Base class for loading AIS trajectories.
    Handles file loading, metadata scanning, and start index sampling.
    """
...
# --- FIX: Standard Class Inheritance (No Decorators) ---
class AISDataset(AISDatasetBase):
    def __init__(self, data_dir, window=64, horizon=12, output_features=2, 
        ...
        # Filter indices based on underlying file length
